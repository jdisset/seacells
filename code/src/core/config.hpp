...
struct Config {
	...
	static constexpr double GRAVITY = 30.0;
	static constexpr double GROUND_REACTION = 0.0003;

	// evo
	static constexpr unsigned int INITIAL_NB_REGULS = 1;
	static constexpr double DEFAULT_SIM_DURATION = 500.0;
	static constexpr double DEFAULT_MAX_CELLS = 750;
	...
	static constexpr unsigned int NB_NUTRIENTS_SOURCES = 260;
	static constexpr double NUTRIENTS_BOUNDING_AREA = 1750.0;
	...
	static constexpr double NUTRIENT_QUANTITY = 0.043;
	static constexpr double NUTRIENT_DEPTH_INCREASE_COEF = 0.039;
	...
	static constexpr double MAX_LIGHT_THRESHOLD = 900.0;
};
#endif
